...
let f_ms_red        = aes_generate_fg_string cc_ms_red
let f_ms_green      = aes_generate_fg_string cc_ms_green
let f_ms_blue       = aes_generate_fg_string cc_ms_blue
let f_ms_yellow     = aes_generate_fg_string cc_ms_yellow
let f_grey6_dark    = aes_generate_fg_string cc_apple_ngrey6_dark
...
let d_all           = aes_generate_decorator_string true true true true
let d_blink         = aes_generate_decorator_string true false false false
let d_italic        = aes_generate_decorator_string false true false false
let d_underline     = aes_generate_decorator_string false false true false
let d_strikethrough = aes_generate_decorator_string false false false true
let d_reset         = aes_decoration_reset